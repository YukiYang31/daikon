...
public class Violation implements Serializable {
   ...
   *
   * @param vioString a string of the form: {@code <INVINFO> property time</INVINFO>} where {@code
   *     property} is valid XML representation of a {@code Property}, and time is {@code <ON_ENTRY>}
   *     or {@code <ON_EXIT>}.
